...
{{/*
Try to determine current user for oauth-proxy
*/}}
{{- define "code-server.currentUser" }}
...
{{/*
Generate domain name for the internet-facing ingress
*/}}
{{- define "code-server.domainName" }}{{ (split "@" (include "code-server.currentUser" .))._0 | replace "." "-" }}-{{ include "code-server.fullname" . }}.{{ .Values.domainNameSuffix }}{{- end }}
